        ...
        void SendEmail(string content)
        {
            try
            {
                ...
                if (list != null && list.Count > 0)
                {
                    ...
                    //这里是测试邮箱，请不要发垃圾邮件，谢谢
                    message.From.Add(new MailboxAddress("261360436", "261360436@qq.com"));
                    message.To.Add(new MailboxAddress("261360436", "261360436@qq.com"));
                    ...
                    using (var client = new SmtpClient())
                    {
                        ...
                        client.Authenticate("261360436", "fmw2613");
                        client.Send(message);
